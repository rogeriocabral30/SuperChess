...
{
    private static BlackPawnManager selectedPawn = null;
    ...
    public GameObject blackArcher, peao, blackMage; 
    ...
    private void Start()
    {
        ...
        arqueiroPreto = FindObjectOfType<BlackArcherManager>(); 
    ...
    public void PromoteArcher()
    {
        ...
        Instantiate(blackArcher, promotePosition, blackArcher.transform.rotation); 
        DeselectPawn();
        Destroy(peao);
    }
    ...
    public void PromoteMage()
    {
        ...
        Instantiate(blackMage, promotePosition, blackMage.transform.rotation); 
        DeselectPawn();
        Destroy(peao);
    }
    ...
    public void Tentativa()
    {
        ...
        if (!tabuleiro.checaCasa((int)currentPos.x + 1, (int)currentPos.z))
        {
            ...
            if (!tabuleiro.checaCasa((int)currentPos.x + 2, (int)currentPos.z) && transform.position.x == 7) 
            {
